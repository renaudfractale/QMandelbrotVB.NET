...
Imports ILGPU.XMath
Public Class Class_Compute2DMandelbrot
    ...
    Shared Sub Kenerl(Index As Index2, NbPoints As Integer, Cote As Double, CX As Double, CY As Double, CZ As Double, Constante As Double, Axe As Integer, indexAxe As Integer, ArrayDatas As ArrayView(Of Byte))
        ...
        Dim Y As Double = CDbl(Index.X) / NbPoints * Cote - Cote / 2.0 + CY
        Dim Z As Double = CDbl(Index.Y) / NbPoints * Cote - Cote / 2.0 + CZ

        Dim X_ As Double = Constante
        Dim W_ As Double = CDbl(indexAxe) / NbPoints * Cote - Cote / 2.0 + CX
        Dim Y_ As Double = CDbl(Index.X) / NbPoints * Cote - Cote / 2.0 + CY
        Dim Z_ As Double = CDbl(Index.Y) / NbPoints * Cote - Cote / 2.0 + CZ
        If Axe = 1 Then
            ...
            W_ = CDbl(Index.X) / CDbl(NbPoints) * Cote - Cote / 2.0 + CX
            Y_ = CDbl(Index.Y) / CDbl(NbPoints) * Cote - Cote / 2.0 + CY
            Z_ = CDbl(indexAxe) / CDbl(NbPoints) * Cote - Cote / 2.0 + CZ
        ...
        ElseIf Axe = 2 Then
            ...
            W_ = CDbl(Index.X) / CDbl(NbPoints) * Cote - Cote / 2.0 + CX
            Y_ = CDbl(indexAxe) / CDbl(NbPoints) * Cote - Cote / 2.0 + CY
            Z_ = CDbl(Index.Y) / CDbl(NbPoints) * Cote - Cote / 2.0 + CZ
