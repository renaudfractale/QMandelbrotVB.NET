...
Public Module Module_2DJulia
    Private Compute2D As Class_Compute2DJulia
    Private Compute3D As Class_Compute3DJulia
    Private ColorMap As Class_ColorMap
    Sub Main(Limite As Double, NbPoint As Integer)

        ColorMap = New Class_ColorMap

        Compute2D = New Class_Compute2DJulia
        Compute2D.CompileKernel(True)


        Compute3D = New Class_Compute3DJulia
        ...
        For i As Integer = 0 To NbPoint - 1
            ...
            GeneratePicture(10000, CByte(5), Contante, i)
        Next
    ...
    Private Sub GeneratePicture(NbPoint As Integer, Seuil As Byte, Constante As Double, Id As Integer)


        Dim Box = GetLimiteBox(Constante, Seuil)
        Log("Box.Size =" + Box.Size.ToString)
        ...
        For Axe As Integer = 0 To 2
            ...
            For index As Integer = 0 To NbPoint - 1 Step 5
                ...
                If Histo.GetEcart = 0 Or Histo.GetMax = 0 Then
                    Log("   Histo.GetMax = 0")
                    Log("   Vidage Memoire Start")
                    Datas2 = Nothing
                    Datas = Nothing
